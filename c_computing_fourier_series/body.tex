...
\begin{frame}<beamer>[plain,t]
        ...
        \begin{tikzpicture}[remember picture,overlay]
          \node[draw=blue!50, fill=blue!20, inner sep=2pt,outer sep=2pt, rounded corners=0.1cm, anchor=south east, yshift=8cm, xshift=-2cm, text width=3cm]  at (current page.south east) {Euler's formula\\$e^{j\theta} = \cos\theta + j\sin\theta$} ;
        \end{tikzpicture}
...
\begin{frame}[plain]{Conjugation and Conjugate Symmetry}
    \mode<beamer>
    {
...
\begin{frame}{Finite-Energy Convergence Criterion}
    ...
    \begin{itemize}[<+->]
        ...
        \item This does not imply that the signal $x(t)$ and its Fourier series representation are equal at every value of $t$. What it does say is that there is no energy in their difference.
