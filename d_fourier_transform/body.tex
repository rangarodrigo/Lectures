...
\begin{frame}{Fourier Transform}
    \begin{itemize}[<+->]
          ...
          \item The synthesis integral itself, which uses these coefficients to represent the signal as a linear combination of complex exponentials, is called the \alert{inverse Fourier transform}.
      \end{itemize}
\end{frame}
