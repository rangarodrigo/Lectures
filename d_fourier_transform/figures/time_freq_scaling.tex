...
\begin{axis}[
	...
	\addplot [red, thick, domain=-3*pi:3*pi, samples=200] plot{\Wa/pi*sin(deg(\Wa*x))/(pi*x)};
...
\begin{axis}[
	...
	\addplot [red, thick] coordinates  {(-5,0) (-\Wa, 0) (-\Wa,1) (\Wa, 1) (\Wa, 0) (5, 0)};
\end{axis}
...
\begin{axis}[
	...
	%\addplot+[red, smooth, mark=none] table [x={n}, y={xn}] {periodic_square_fs_samples_of_envilope_gen.dat};
	\addplot [red, thick, domain=-3*pi:3*pi, samples=200] plot{\Wb/pi*sin(deg(\Wb*x))/(pi*x)};
...
\begin{axis}[
	...
	\addplot [red, thick] coordinates  {(-5,0) (-\Wb, 0) (-\Wb,1) (\Wb, 1) (\Wb, 0) (5, 0)};
\end{axis}


\begin{axis}[
	name=sinc3,
	at=(sinc2.south), anchor=north, yshift=-0.9cm,
	y=1cm,
	x=0.4cm,
	 clip=false,
	 xmin=-9,xmax=9,
	...
	%\addplot+[red, smooth, mark=none] table [x={n}, y={xn}] {periodic_square_fs_samples_of_envilope_gen.dat};
	\addplot [red, thick, domain=-3*pi:3*pi, samples=200] plot{\Wc/pi*sin(deg(\Wc*x))/(pi*x)};
...
\begin{axis}[
	...
	\addplot [red, thick] coordinates  {(-4,0) (-\Wc, 0) (-\Wc,1) (\Wc, 1) (\Wc, 0) (4, 0)};
\end{axis}
